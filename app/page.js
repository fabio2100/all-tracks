 ...
 const router = useRouter();
  ...
  useEffect(() => {
     const checkTokens = async () => {
       ...
       if(Cookies.get('spotify_access_token') && Cookies.get('spotify_refresh_token')){
        router.push('/home')
       }
     };
  ...
  const handleLogin = () => {
    ...
    const authUrl = `https://accounts.spotify.com/authorize?response_type=code&client_id=${clientId}&scope=${scope}&redirect_uri=${encodeURIComponent(
      redirectUri
    )}`;
